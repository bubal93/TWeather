...
public class Utility {
    ...
    /**
     * Helper method to return whether or not TWeather is using local graphics.
     *
     * @param context Context to use for retrieving the preference
     * @return true if TWeather is using local graphics, false otherwise.
     */
    public static boolean usingLocalGraphics(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String tweatherArtPack = context.getString(R.string.pref_art_pack_tweather);
        return prefs.getString(context.getString(R.string.pref_art_pack_key),
                tweatherArtPack).equals(tweatherArtPack);
    }
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        String formatArtUrl = prefs.getString(context.getString(R.string.pref_art_pack_key),
                context.getString(R.string.pref_art_pack_tweather));
    ...
    public static int getArtResourceForWeatherCondition(int weatherId) {
        ...
        if (weatherId >= 200 && weatherId <= 232) {
            ...
            return R.drawable.ic_art_fog;
        } else if (weatherId == 761 || weatherId == 781) {
            return R.drawable.ic_art_storm;
        } else if (weatherId == 800) {
            return R.drawable.ic_art_clear;
        } else if (weatherId == 801) {
            return R.drawable.ic_art_light_clouds;
        } else if (weatherId >= 802 && weatherId <= 804) {
            return R.drawable.ic_art_clouds;
        }
        return -1;
    }
 ...
 */
    ...
    static public
    @TweatherSyncAdapter.LocationStatus
    int getLocationStatus(Context c) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        return sp.getInt(c.getString(R.string.pref_location_status_key), TweatherSyncAdapter.LOCATION_STATUS_UNKNOWN);
    }

    /**
     * Resets the location status.  (Sets it to TweatherSyncAdapter.LOCATION_STATUS_UNKNOWN)
     *
     * @param c Context used to get the SharedPreferences
     */
    static public void resetLocationStatus(Context c) {
        ...
        spe.putInt(c.getString(R.string.pref_location_status_key), TweatherSyncAdapter.LOCATION_STATUS_UNKNOWN);
        spe.apply();
    }
}
