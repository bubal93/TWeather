...
import bubal.tweather.BuildConfig;
import bubal.tweather.MainActivity;
...
public class TweatherSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public TweatherSyncAdapter(Context context, boolean autoInitialize) {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                // Adding a newline for debugging
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        TweatherSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
